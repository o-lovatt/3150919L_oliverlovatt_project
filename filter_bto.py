...
#distance_km & find_closest_prediciton moved out of main() for testing
#so entire BTO pipleline doesn't run everytime they're tested
...
def main(): #added for testing
    #(everything now indented into main for testing)
    # [STUDENT-WRITTEN]
