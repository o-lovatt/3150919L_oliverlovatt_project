...
export const KM_PER_DEG_LON = KM_PER_DEG_LAT * Math.cos(REFERENCE_LAT * Math.PI / 180);

//export now added so these variables can be accessed by getPredictionsNearLocation
